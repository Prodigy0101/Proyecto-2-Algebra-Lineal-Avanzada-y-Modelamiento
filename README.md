...
Luego `Kernel → Restart & Run All`. También funciona directamente en **Google Colab** (subir el `.ipynb`). La primera celda descarga el dataset automáticamente; no hay pasos manuales. Los resultados son reproducibles.
...
- Convergencia de la iteración de potencias en **107 iteraciones** (ε = 10⁻¹⁰, α = 0.85).
